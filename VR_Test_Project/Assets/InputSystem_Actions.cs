...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""Gun"",
            ""id"": ""27497bf7-65e3-4af4-92ea-ce5cc6b7f33e"",
            ""actions"": [
                {
                    ""name"": ""Shoot"",
                    ""type"": ""Button"",
                    ""id"": ""476c2b30-9ff5-4ee9-8072-3569fc58320f"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""4aa23796-ef2c-458e-9463-60213f7a0555"",
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_Gun.enabled, "This will cause a leak and performance issues, InputSystem_Actions.Gun.Disable() has not been called.");
    }
    ...
    public struct GunActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public GunActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
